...
import {FaCcPaypal, FaCcVisa, FaCcDiscover, FaCcMastercard} from 'react-icons/fa'
...
<div className="Shipping_Bar_Text_Cont">
<p className="Shipping_Bar_Text" style={{width:'100%'}}>{(itemspec != "") ? (itemspec.Item.ShippingCostSummary.ShippingType == "Calculated" ? "Calculated at Checkout" : "$"+ itemspec.Item.ShippingCostSummary.ShippingServiceCost.Value) : null}</p>
</div>
<div className="Shipping_Bar_Text_Cont">
...
<div className="Payment_Bar_Text_Cont" >
    <p className="Payment_Bar_Title" style={{ textAlign:'center'}} >Payment Methods</p>
                ...
                <div >
<div className="Payment_Bar_Text_Cont" >
    <p className="Payment_Bar_Text" style={{textAlign:'center'}} ><FaCcPaypal className="Payment_Icon" size={18}/> <FaCcVisa className="Payment_Icon" size={18} /> <FaCcMastercard className="Payment_Icon" size={18} /> <FaCcDiscover className="Payment_Icon" size={18} /></p>
</div>
